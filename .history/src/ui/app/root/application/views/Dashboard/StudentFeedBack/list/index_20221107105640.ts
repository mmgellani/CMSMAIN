...
export class StudentFeedback extends Vue {
  ...
  User = [{ items: 'All' }, { items: 'Parent' }, { items: 'Student' } ];
  private uservalue: string = 'All';
  ...
  loadData(){
    ...
    var key = helper.formateDate(this.fromDate) + "?" + helper.formateDate(this.toDate) + "?" + this.user.userId+"?"+this.uservalue;
