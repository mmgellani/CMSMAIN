...
{
    public interface ITimeTableSlotsRepository:IEntityRepository<TimeTableSlots>{  }
    public class TimeTableSlotsRepository : EntityRepository<TimeTableSlots>, ITimeTableSlotsRepository
    {
        public TimeTableSlotsRepository(DbContextBase context) : base(context) { }
    }
