...
import { IAdmissionEligibilityCriteria } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'AdmissionEligibilityCriteria/';

export class AdmissionEligibilityCriteriaService extends StoreService {
    ...
    public GetEligibiltyCriteria(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetEligibilityCriteria', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }

    public GetEligibiltyCriteriaBySession(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetEligibilityCriteriaBySession', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
