...
const BASE_URL = GlobalConfig.uri.services + 'StruckoffReinstate/';

export class StruckoffReinstateService extends StoreService {
    ...
    public GetStudentStruckoff(predicate: string) {
        
        return this.exec<any>(Axios.post(BASE_URL + 'GetStudentStruckOff', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public StruckofListData(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'StruckofListData', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public CheckStruckoff(entity: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'CheckStruckoff', { ProvidedString: entity }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
