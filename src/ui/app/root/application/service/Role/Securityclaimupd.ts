...
import { ISecurityClaimUpd } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'SecurityClaimUpd/';

export class SecurityClaimUpdService extends StoreService {
    ...
    public InsertSecurityClaims(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'InsertSecurityClaims', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public Delete(predicate: string) {
        
        return this.exec<any>(Axios.post(BASE_URL + 'Delete', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
