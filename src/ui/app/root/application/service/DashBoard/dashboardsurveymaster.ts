...
const BASE_URL = GlobalConfig.uri.services + 'SurveyMaster/';

export class SurveyDashboardMasterService extends StoreService {
    ...
    public GetQueryType() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetQueryType'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
