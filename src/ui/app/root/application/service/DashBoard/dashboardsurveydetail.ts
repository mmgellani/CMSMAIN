...
const BASE_URL = GlobalConfig.uri.services + 'SurveyDetail/';

export class SurveyDashboardDetailService extends StoreService {
    ...
    public GetAllSurveyDetail() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllSurveyDetail'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    InsertSurveyDetail(predicate:string)
    {
        
            return this.exec<any>(Axios.post(BASE_URL + 'InsertSurveyDetail', { ProvidedString: predicate }))
                        .then((value) => this.processPayload(value))
                        .catch((error) => console.error(error));
    ...
    InsertNotification(predicate:string)
    {
        
            return this.exec<any>(Axios.post(BASE_URL + 'InsertNotification', { ProvidedString: predicate }))
                        .then((value) => this.processPayload(value))
                        .catch((error) => console.error(error));
