...
const BASE_URL = GlobalConfig.uri.services + 'ELChapters/';

export class ELChaptersService extends StoreService {
    ...
    public GetAllChapters(datavalue: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllChapters', { ProvidedString: datavalue }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetChaptersList(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetChaptersList', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    
    public GetChapters(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetChapters', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
