...
import { IFeeScholarshipCriteria } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'FeeScholarshipCriteria/';

export class FeeScholarshipCriteriaService extends StoreService {
    ...
    public ApplyBulkScholarship(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'ApplyBulkScholarship', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetAllGrades() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllGrades'))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public GetAllVMByEx(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllVMByEx', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetAllVMBy(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllVMBy', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetAllVMByAdmissionConcession(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllVMByAdmissionConcession', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public AddBulkScholarship(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'AddBulkScholarshipScholarshipCriteria', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
