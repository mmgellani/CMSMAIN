...
import { IFeeConcession } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'FeeConcession/';

export class FeeConcessionService extends StoreService {
    ...
    public GetExistingConcession(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetExistingConcession', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
