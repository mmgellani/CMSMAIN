...
const BASE_URL = GlobalConfig.uri.services + 'FeeFeeStructure/';

export class FeeFeeStructureService extends StoreService {
    ...
    public GetBulkVM(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetBulkVM', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public GetFindByVM(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByVM', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public GetFindByVMEx(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByVMEx', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public DeleteFeestructure(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'DeleteFeestructure', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public FeeSum(key: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'FeeSum', { providedString: key }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
