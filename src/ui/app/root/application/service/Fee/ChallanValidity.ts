...
const BASE_URL = GlobalConfig.uri.services + 'FeeChallanValidity/';

export class FeeChallanValidityService extends StoreService {
    ...
    public GetFindByEx2(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByEx2', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetStudentList(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetStudentList', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public get_challan_report(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'get_challan_report', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public get_challan_reportEx(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'get_challan_reportEx', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public get_challan_reportBulk(predicate: string) {
        
        return this.exec<any>(Axios.post(BASE_URL + 'get_challan_reportBulk', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public StudentUserGen(entity: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'StudentUserGen', { ProvidedString: entity }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
