...
const BASE_URL = GlobalConfig.uri.services + 'FeeCampusBankLink/';

export class FeeCampusBankLinkService extends StoreService {
    ...
    public GetByCampus(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetByCampus', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetAllAsync() {
    ...
    public GetBank(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetBank', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public GetBankEx(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetBankEx', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public GetBankAll(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetBankAll', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
