...
const BASE_URL = GlobalConfig.uri.services + 'BoardBoardCampus/';

export class BoardBoardCampusService extends StoreService {
    ...
    // }
    // public GetAllVMSM() {
    //     return this.exec<any>(Axios.get(BASE_URL + 'GetAllVMSM'))
    //                 .then((value) => this.processPayload(value))
    //                 .catch((error) => console.error(error));
    // }
    // public GetAllVMByZone(key:string) {
    //     return this.exec<any>(Axios.post(BASE_URL + 'GetAllVMByZone',{providedString:key}))
    //                 .then((value) => this.processPayload(value))
    //                 .catch((error) => console.error(error));
    // }
    ...
    public GetBoardCampus(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetBoardCampus', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
