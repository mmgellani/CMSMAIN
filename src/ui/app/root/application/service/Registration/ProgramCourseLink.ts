...
import { IRegistrationProgramCourseLink } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'RegistrationProgramCourseLink/';

export class RegistrationProgramCourseLinkService extends StoreService {
    ...
    public GetByClassId(key:string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetByClassId',{providedString:key}))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllAsync() {
    ...
    public GetAllFilterDataForList(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllFilterDataForList', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetExamCourseList(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetExamCourseList', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
