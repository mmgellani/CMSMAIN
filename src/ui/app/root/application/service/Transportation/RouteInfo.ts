...
const BASE_URL = GlobalConfig.uri.services + 'TransportationRouteInfo/';

export class TransportationRouteInfoService extends StoreService {
    ...
    public GetRouteInfoByStudentId(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetRoutesByStudentId', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
