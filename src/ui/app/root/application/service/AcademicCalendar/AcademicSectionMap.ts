...
//import { IAcademicSectionMap } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'AcademicSectionMap/';

export class AcademicSectionMapService extends StoreService {
    ...
    public GetAcademicSectionMapList(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAcademicSectionMapList', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public AddAcademicSectionMapBulkInsertion(predicate: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'AddAcademicSectionMapBulkInsertion', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
