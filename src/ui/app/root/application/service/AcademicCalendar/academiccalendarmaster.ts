...
const BASE_URL = GlobalConfig.uri.services + 'AcademicCalendarMaster/';

export class AcademicCalendarMasterService extends StoreService {
    ...
    public GetFindByIds(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByIds', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetCalendarMasterBoardWise(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetCalendarMasterBoardWise', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public GetAcadmicCaldenview(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAcadmicCaldenview', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    

    public GetApprovedCalendar(predicate: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetApprovedCalendar', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetApprovedCalendarEx(predicate: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetApprovedCalendarEx', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
