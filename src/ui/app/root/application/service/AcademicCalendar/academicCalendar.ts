...
const BASE_URL = GlobalConfig.uri.services + 'AcademicCalendar/';

export class AcademicCalendarService extends StoreService {
    ...
    // public GetAllActive() {
    //     return this.exec<any>(Axios.get(BASE_URL + 'GetAllActiveAsync'))
    //                 .then((value) => this.processPayload(value))
    //                 .catch((error) => console.error(error));
    // }
    public GetAllAsync() {
    ...
    public GetAcademicCalendarView(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAcademicCalendarView', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAcademicCalendarSingleData(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAcademicCalendarSingleData', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public DeleteCalendar(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'DeleteCalendar', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public GetMonthlyPlanner(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetMonthlyPlanner', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
  
    public GetSubWiseCalendarReport(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetSubWiseCalendarReport', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public CheckFullWeekEnable(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'CheckFullWeekEnable', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public DeleteOldIds(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'DeleteOldIds', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public DeleteFullWeekIds(datavalue: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'DeleteFullWeekIds', { ProvidedString: datavalue }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
}