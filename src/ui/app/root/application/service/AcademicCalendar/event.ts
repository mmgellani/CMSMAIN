...
const BASE_URL = GlobalConfig.uri.services + 'AcademicCalendarEvent/';

export class AcademicCalendarEventService extends StoreService {
    ...
    public GetAllEvents() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllEvents'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetEvents(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetEvents', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllActive() {
