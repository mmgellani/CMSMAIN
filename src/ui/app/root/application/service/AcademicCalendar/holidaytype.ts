...
const BASE_URL = GlobalConfig.uri.services + 'HolidayType/';

export class HolidayTypeService extends StoreService {
    ...
    public GetAllHolidays() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllHolidays'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetHolidays(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetHolidays', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllActive() {
    ...
    public InsertHolidays(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'InsertHolidays', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
