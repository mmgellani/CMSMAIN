...
const BASE_URL = GlobalConfig.uri.services + 'CalendarExamType/';

export class CalendarExamTtypeService extends StoreService {
    ...
    public DeleteCalendarExam(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'DeleteCalendarExam', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
