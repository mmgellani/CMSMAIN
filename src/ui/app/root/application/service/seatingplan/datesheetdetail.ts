...
const BASE_URL = GlobalConfig.uri.services + 'DateSheetDetail/';

export class SeatingPlanDateSheetDetailService extends StoreService {
    ...
    public GetFindByOne() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetFindByOne'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public GetAllDateSheetDetailVM(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllDateSheetDetailVM', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
