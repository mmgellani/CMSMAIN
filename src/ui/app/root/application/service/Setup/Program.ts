...
const BASE_URL = GlobalConfig.uri.services + 'SetupProgram/';

export class SetupProgramService extends StoreService {
    ...
    public ProgramByCampus(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'ProgramByCampus', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
