...
const BASE_URL = GlobalConfig.uri.services + 'SetupConcessionRemarks/';

export class SetupConcessionRemarksService extends StoreService {
    ...
    public GetAllActiveEx(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllActiveEx', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }

    public GetAllActive(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllActive', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllAsync() {
