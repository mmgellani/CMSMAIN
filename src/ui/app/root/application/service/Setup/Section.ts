...
const BASE_URL = GlobalConfig.uri.services + 'SetupSection/';

export class SetupSectionService extends StoreService {
    constructor(store: Store<{}>) {
        super(store);
    }
    public GetAllSection() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllSection'))
