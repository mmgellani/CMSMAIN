...
import { ISetupProgramDetails } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'SetupProgramDetails/';

export class SetupProgramDetailsService extends StoreService {
    ...
    public GetAllByProgramVM(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllByProgramVM', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllVM(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllVM', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllAsync() {
    ...
    public GetPreSubInstallment(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetPreSubInstallment', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
}