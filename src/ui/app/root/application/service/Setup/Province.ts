...
import { ISetupProvince, ISetupProvinceVM } from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'SetupProvince/';

export class SetupProvinceService extends StoreService {
    ...
    public GetAllActive() {
        return this.exec<Array<ISetupProvinceVM>>(Axios.get(BASE_URL + 'GetAllActiveAsync'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
