...
import { ISetupSubCity} from '../../models';

const BASE_URL = GlobalConfig.uri.services + 'SetupSubCity/';

export class SetupSubCityService extends StoreService {
    ...
    public GetFindByOwnedSubCitites(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByOwnedSubCitites', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public GetFindBySubcitiesEx(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindBySubcitiesEx', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetFindByCitySubCity(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByCitySubCity', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetFindByCitySubCityEx(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindByCitySubCityEx', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
