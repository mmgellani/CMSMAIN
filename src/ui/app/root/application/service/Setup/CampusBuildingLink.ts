...
const BASE_URL = GlobalConfig.uri.services + 'SetupCampusBuildingLink/';

export class SetupCampusBuildingLinkService extends StoreService {
    ...
    public GetAllActive() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllActive'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetAllActiveEx() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllActiveEx'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
