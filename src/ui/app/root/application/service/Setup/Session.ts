...
const BASE_URL = GlobalConfig.uri.services + 'SetupSession/';

export class SetupSessionService extends StoreService {
    ...
    public GetFindBy1(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFindBy1', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public QuizSessionGet() {
        return this.exec<any>(Axios.get(BASE_URL + 'QuizSessionGet'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
}