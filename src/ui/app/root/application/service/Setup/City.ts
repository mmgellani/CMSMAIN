...
const BASE_URL = GlobalConfig.uri.services + 'SetupCity/';
const BASE_URLQuiz = GlobalConfig.uri.services + 'Quiz/';

export class SetupCityService extends StoreService {
    ...
    public GetAllEx() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllEx'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    } 
    
    public GetAllOwnedCitiesForEbook() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetAllOwnedCitiesForEbook'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    } 
    public GetAllExpossession(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetAllExpossession', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetCityEx() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetCityEx'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public SaveQuizConfigration(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URLQuiz + 'SaveQuizConfigration', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public SaveLeagueConfigration(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URLQuiz + 'SaveLeagueConfigration', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    public GetLeagueList(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URLQuiz + 'GetLeagueList', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
}