...
const BASE_URL = GlobalConfig.uri.services + 'ExaminationCampusGradingPolicyLink/';

export class ExaminationCampusGradingPolicyLinkService extends StoreService {
