...
const BASE_URL = GlobalConfig.uri.services + 'ExaminationCampusFailCriteriaMapping/';

export class ExaminationCampusFailCriteriaMappingService extends StoreService {
