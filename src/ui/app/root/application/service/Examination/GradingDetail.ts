...
const BASE_URL = GlobalConfig.uri.services + 'ExaminationGradingDetail/';

export class ExaminationGradingDetailService extends StoreService {
    ...
    public GetFind(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetFind', { ProvidedString: predicate }))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public DeleteGradingDetail(entity: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'DeleteGradingDetail', { ProvidedString: entity }))
        .then((value) => this.processPayload(value))
        .catch((error) => console.error(error));
    }
