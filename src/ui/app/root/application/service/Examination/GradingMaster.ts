...
const BASE_URL = GlobalConfig.uri.services + 'ExaminationGradingMaster/';

export class ExaminationGradingMasterService extends StoreService {
    ...
    public GetGradingMasterDetail() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetGradingMasterDetail'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }

    public GetGradingMasterDetailEx() {
        return this.exec<any>(Axios.get(BASE_URL + 'GetGradingMasterDetailEx'))
                    .then((value) => this.processPayload(value))
                    .catch((error) => console.error(error));
    }
    ...
    public AddBulk(entity: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'AddBulk', { ProvidedString: entity }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public EditBulkCriteria(entity: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'EditBulkCriteria', { ProvidedString: entity }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
