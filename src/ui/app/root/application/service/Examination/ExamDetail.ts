...
const BASE_URL = GlobalConfig.uri.services + 'ExaminationExamDetail/';

export class ExaminationExamDetailService extends StoreService {
    ...
    public GetTeacherExamData(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetTeacherExamData', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetTeacherExamDataEX(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetTeacherExamDataEX', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public UpdateExamBulk(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'UpdateExamBulk', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetExamUpdateData(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetExamUpdateData', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public GetExamUpdateDataExam2(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetExamUpdateDataExam2', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    
    public GetExamScheduleUpdateData(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetExamScheduleUpdateData', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }

    public GetExamScheduleBulkPreview(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetExamScheduleBulkPreview', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public InsertExamBulk(entity: any) {
        return this.exec<any>(Axios.post(BASE_URL + 'InsertExamBulk', { ProvidedString: entity }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    ...
    public GetTeacherSection(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetTeacherSection', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
    public GetTeacherCourse(predicate: string) {
        return this.exec<any>(Axios.post(BASE_URL + 'GetTeacherCourse', { ProvidedString: predicate }))
            .then((value) => this.processPayload(value))
            .catch((error) => console.error(error));
    }
