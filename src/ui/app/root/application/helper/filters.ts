...
Vue.filter("formatDMY", function (value) {
  if(value && value.indexOf('0001-01-01')) {
    return '';
  }
...
Vue.filter("prettyJson", function (value) {
  return JSON.stringify(value)
    .replace(/"/g, '')
    .replace(/{\\/g, '<div class="row"> <div class="col-md-4">')
    .replace(/\\:\\/g, '</div> <div class="col-md-8">')
    .replace(/\\,\\/g, '</div> </div> <div class="row"> <div class="col-md-4">')
    .replace(/\\:/g, '</div> <div class="col-md-8">')
    .replace(/,\\/g, '</div> </div> <div class="row"> <div class="col-md-4">')
    .replace(/\\}/g, '</div> </div>')
    .replace(/\\\\/g, '');
