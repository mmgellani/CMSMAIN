...
export class ELQuestionsDelete extends Vue {
    private repository: ELQuestionsService;
    private data: IELQuestions = { questionId: '', topicId: '', fullQuestion: '', questionType: 0, difficultyLevel: 0, answers: '', orderNumber: 0, statusId: 0,loggerId:'' };
