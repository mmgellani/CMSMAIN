...
export class AttendanceAttendenceStatusDelete extends Vue {
    private repository: AttendanceAttendenceStatusService;
    private data: IAttendanceAttendenceStatus = { attendenceStatusId: '', code: '', fullName: '', statusId: 0, loggerId: '',  };
