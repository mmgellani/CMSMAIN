...
export class AttendanceTeacher extends Vue {
    ...
    validatePage() {
        if (this.user.roles.indexOf('admin') >= 0) {
            ...
            if (('attendanceTeacher' in this.user.claims) == true) {
                if (this.user.claims['attendanceTeacher'].indexOf('R') >= 0) {
                    this.canRead = true;
                }
                if (this.user.claims['attendanceTeacher'].indexOf('C') >= 0) {
                    this.canAdd = true;
                }
                if (this.user.claims['attendanceTeacher'].indexOf('U') >= 0) {
                    this.canEdit = true;
                }
                if (this.user.claims['attendanceTeacher'].indexOf('D') >= 0) {
                    this.canDelete = true;
                }
            } else {
