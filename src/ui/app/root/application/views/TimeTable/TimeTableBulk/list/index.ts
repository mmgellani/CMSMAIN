...
import { TimeTableTimeTableBulkAddEdit } from "../add-edit";
import { TimeTableTimeTableBulkDelete } from "../delete";
...
@Component({
  ...
  components: {
    "add-edit-model": TimeTableTimeTableBulkAddEdit,
    "delete-model": TimeTableTimeTableBulkDelete,
    // "report-engine": ReportEngine
  }
})
export class TimeTableTimeTableBulkList extends Vue {
