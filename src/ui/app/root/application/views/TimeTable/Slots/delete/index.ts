...
import { ITimeTableSlots } from '../../../../models';
...
export class TimeTableSlotsDelete extends Vue {
    private repository: TimeTableSlotsService;
    private data: ITimeTableSlots = { slotId: '', shiftId: '',  startTime: '', endTime: '', statusId: 0, loggerId: '',  };
