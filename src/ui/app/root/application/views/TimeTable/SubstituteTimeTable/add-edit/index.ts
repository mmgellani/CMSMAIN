...
import { ITimeTableTimeTable, IRegistrationSectionCourseLinkVM, IRegistrationSectionCourseLink, ISetupRoom, IHumanResourceStaff, ITimeTableSlotTimingsVM, ITimeTableTimeTableVM, RegistrationProgramCourseLinkVM, ISetupCampusProgramLinkVM, ISetupCampusProgramLink, ISetupRoomTypeBuildingVM, dayofweek } from '../../../../models';
...
export class TimeTableTimeTableAddEdit extends Vue {
    ...
    allowsubmit()
    {
        ...
        && this.data.roomId.length>0 && this.data.dayName.length>0 
        && this.data.slotTimingId.length>0
