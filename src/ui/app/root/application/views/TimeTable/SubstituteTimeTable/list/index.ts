...
export class SubstituteTimeTableTimeTableList extends Vue {
  ...
  validatePage() {
    if (this.user.roles.indexOf("admin") >= 0) {
      ...
      if ("substituteTimeTable" in this.user.claims == true) {
        if (this.user.claims["substituteTimeTable"].indexOf("R") >= 0) {
          this.canRead = true;
        }
        if (this.user.claims["substituteTimeTable"].indexOf("C") >= 0) {
          this.canAdd = true;
        }
        if (this.user.claims["substituteTimeTable"].indexOf("U") >= 0) {
          this.canEdit = true;
        }
        if (this.user.claims["substituteTimeTable"].indexOf("D") >= 0) {
          this.canDelete = true;
        }
      } else {
