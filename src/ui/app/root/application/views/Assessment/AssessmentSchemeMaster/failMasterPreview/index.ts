...
@Component({
    ...
    name: 'fail-master-preview',
    template: require('./index.html')
})
export class FailMasterPreview extends Vue {

    private IsNewRecord: boolean = true;
    private title: string = '';
      private newParam: boolean = false;
    private failMaster: IExaminationFailMasterCriteria = {
        absentConsiderFail: this.newParam, failMarks: 0, failMasterId: '',
    ...
    failMasterId=''
    absentConsiderFail=this.newParam
    failIn=0
    failMarks=0
    failMasterName=''
    created() {
    ...
    beforeModalOpen(event) {
        ...
        this.failMasterId=event.params.failMaster;
        this.failMarks=event.params.failMarks;
        this.failMasterName=event.params.failMasterName;
        this.failIn=event.params.failIn;
        // this.newParam=event.params.absentConsiderFail;
        // this.absentConsiderFail=this.newParam;
        //this.absentConsiderFail=event.params.absentConsiderFail;
        ...
        if (this.IsNewRecord) {
            ...
            this.repo.GetFailDetailById(this.failMasterId)
                .then(r => {
    ...
    cancel() {
        ...
        this.failMaster = {
            absentConsiderFail:this.absentConsiderFail, 
            failMarks: 0, failMasterId: '',
            fail_In: 0, loggerId: helper.newGuid(), statusId: 1, fullName: ''
        }
        this.detailLength = 0;
        this.$modal.hide('fail-master-preview');
