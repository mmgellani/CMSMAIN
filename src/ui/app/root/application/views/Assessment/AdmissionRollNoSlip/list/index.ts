...
export class AdmissionRollNoSlip extends Vue {
    ...
    validatePage() {
        if (this.user.roles.indexOf('admin') >= 0) {
            ...
            if (('admissionRollNoSlip' in this.user.claims) == true) {
                if (this.user.claims['admissionRollNoSlip'].indexOf('R') >= 0) {
                    this.canRead = true;
                }
                if (this.user.claims['admissionRollNoSlip'].indexOf('C') >= 0) {
                    this.canAdd = true;
                }
                if (this.user.claims['admissionRollNoSlip'].indexOf('U') >= 0) {
                    this.canEdit = true;
                }
                if (this.user.claims['admissionRollNoSlip'].indexOf('D') >= 0) {
                    this.canDelete = true;
                }
            } else {
