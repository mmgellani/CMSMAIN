...
import { NewCalendarPopup } from "../add-edit";
import { IAcademicCalendarView } from "../../../../models/academiccalendar/academicCalendar";
import moment from "moment";

import { ViewCalendarNewPopup } from "../viewDetail";
...
@Component({
  ...
  components: {
    calendar: Calendar,
    "add-edit": NewCalendarPopup,
    "view-Popup": ViewCalendarNewPopup,
    "delete-model": AcademicCalendarNewDelete,
  },
})
export class AcademicCalendarNew extends Vue {
  ...
  onBeforeCreateSchedule(e) {
    ...
    if (
      ...
      this.$modal.show("cal-add-edit-model", {
        ...
        MYFROMDATE:moment(e.start._date).format("YYYY-MM-DD")
