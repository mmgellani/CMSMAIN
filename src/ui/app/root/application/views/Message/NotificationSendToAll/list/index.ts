...
import { SetupSessionService, SetupCampusService, SetupProgramDetailsService, SetupClassService, SetupSectionService, SetupCampusProgramLinkService, TransportationVehicleInfoService, RegistrationEnrollmentsService, SetupGenderService } from '../../../../service';
...
export class NotificationForAll extends Vue {
    ...
    AddNotific() {
        ...
        if (this.sessionId.length > 0 && this.classId.length > 0) {
            ...
            // this.refreshdropdowns();
             var session = "00000000-0000-0000-0000-000000000000";
            //var campus = "00000000-0000-0000-0000-000000000000";
           // var CampusProgramId = "00000000-0000-0000-0000-000000000000";
           // var cclassid = "00000000-0000-0000-0000-000000000000";
            //var gender = "00000000-0000-0000-0000-000000000000";
           // var sectionCourseLink = "00000000-0000-0000-0000-000000000000";
          //  var srollno = "00000000-0000-0000-0000-000000000000";
           // var notifType = "General";

           // var stringwithoutbraces = "00000000-0000-0000-0000-000000000000";
           // var session = "0";
            var campus = "0";
...
debugger
                ...
                var dataNotification: INotificationCredntialsEx = {
                    tempId: helper.newGuid(),
                    sesseion: session,
                    campus:'0'?"00000000-0000-0000-0000-000000000000": campus,
                    program: CampusProgramId,
                    classstudent: cclassid,
                ...
                this.temparray.forEach(s => {
                    ...
                    var tag = this.sessionModel.find(e => e.sessionId == this.sessionId).fullName;
                   tag = tag + "ALL" ? null :this.campusCityList.find(e => e.campusId == this.campusIdEx).campusName;
    ...
    refreshList() {
        ...
        if (this.sectionCourseLinkId.length > 0) {
            this.dataNotificationTemp.forEach(e => {
                ...
                if (this.list.find(s => s.campusProgramId == e.program) == null || this.list.find(s => s.sectionCourseLinkId == e.section) == null) {
                    this.list.push({
                        tempId: e.tempId,
                        campusProgramId:'0'?"ALL" : e.program,
                        sectionCourseLinkId:'0'?"ALL": e.section,
                        sessionName: this.sessionModel.find(s => s.sessionId == e.sesseion).fullName,
                        campusName:'00000000-0000-0000-0000-000000000000'?"ALL" : this.campusCityList.find(s => s.campusId == e.campus).campusName,
                        programName:'0'?"All": this.campusProgramLinkList.find(s => s.campusProgramId == e.program).description,
                        class: this.classList.find(s => s.classId == e.classstudent).fullName,
                        section: '0'?"ALL": this.sectionList.find(s => s.sectionCourseLinkId == e.section).sectionName == 'undefined' ? 'heheh' : this.sectionList.find(s => s.sectionCourseLinkId == e.section).sectionName,
                        gender: e.genderr == '00000000-0000-0000-0000-000000000000' ? "ALL" : this.genderModel.find(s => s.genderId == e.genderr).description,
                        type: e.type,
                        title: e.title,
                        tag: e.tag
                    })
            ...
            this.dataNotificationTemp.forEach(e => {
                console.log(this.campusProgramLinkList.length)
                if (this.list.find(s => s.campusProgramId == e.program) == null) {
                    this.list.push({
                        tempId: e.tempId,
                        campusProgramId: e.program,
                        sectionCourseLinkId: e.section,
                        sessionName: this.sessionModel.find(s => s.sessionId == e.sesseion).fullName,
                        campusName: e.campus == '00000000-0000-0000-0000-000000000000' ? null : this.campusCityList.find(s => s.campusId == e.campus).campusName,
    ...
    loadCityCampus() {
        ...
        this.campusRepo.GetCityVM().then(r => {
            ...
            if (this.checkEntity == 'CMS') {
                ...
                this.campusCityList = this.campusCityList.filter(e => e.campusId == 'e75a4360-44e2-4712-a173-47614a3f880c')
            }
        });
