...
import { ISetupSession, ISetupCampus, DDLModel, DDLGroupModel, ISetupClass, ICampusCityVM,
    IRegistrationSectionCourseLinkVMEX, ISetupCampusProgramVMEX,ISetupCampusProgramVM, ISetupSection, IRegistrationSectionCourseLinkVM, ISetupGender } from '../../../../models';
...
export class NotificationNew extends Vue {
    ...
    private sectionList1: Array<IRegistrationSectionCourseLinkVMEX> = [];
    ...
    campusProgramLinkListEX: Array<ISetupCampusProgramVMEX> = [];
    ...
    loadSections() {
        if (this.issection == true) {
            ...
            this.enrollmentRepo.GetSectionList(key)
                .then(r => {
                    this.sectionList1 = r as Array<IRegistrationSectionCourseLinkVMEX>;
                    debugger;
    ...
    loadSectionsEx() {
        ...
        // if (this.issection == true && this.programId.length == 1) {
        //     this.sectionList = [];
        //     // this.campusProgramId = this.campusProgramLinkList.find(e => e.campusId == this.campusId && e.sessionId == this.sessionId && e.programDetailId == this.programDetailId && e.statusId == 1).campusProgramId;

        //     var key = this.programId;
        //     this.enrollmentRepo.GetProgramDesc(key)
        //         .then(r => {
        //             this.sectionList1 = r as Array<IRegistrationSectionCourseLinkVMEX>;
        //              if (this.sectionList == null) {
        //                 this.$store.dispatch(StoreTypes.updateStatusBar, {
        //                     text: 'Description not Defined',
        //                     title: 'warning',
        //                     messageTypeId: PayloadMessageTypes.warning
        //                 });
        //             }
    ...
    loadProgramsOfCampusEx() {
        ...
        var key = this.campusIdEx;
        this.campusProgramLinkRepo.GetAllVMEx(key).then((r) => {
            this.campusProgramLinkListEX = r as Array<ISetupCampusProgramVMEX>;
        });
    }
