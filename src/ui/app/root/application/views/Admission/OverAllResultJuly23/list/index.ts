...
export class OverAllResultJuly23 extends Vue {
  ...
  loadTotalSurvey() {
    this.survey = [];
    this.repository
      .TotalSurveyExJul23('4063768d-34df-4829-a811-f92bebf857a1?08594f95-bdbb-4f0a-aa54-9ea5dc8c46c9')
  ...
  loadPosessionDataSurvey(id) {
    if (this.typeId == "Owned") {
      ...
      this.repository.SurveyStatisticsEx1LatestJuly23(key).then((r) => {
        if (r) {
  ...
  loadCityDataSurvey(id) {
    ...
    if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {
      ...
      var key = this.subCityId + "?" + 'building' + "?" + this.user.userId + "?" + '4063768d-34df-4829-a811-f92bebf857a1' + "?" + '08594f95-bdbb-4f0a-aa54-9ea5dc8c46c9' + "?" + this.buildingname;
      this.repository.GetSurveyCityJuly23WithBuilding(key).then((r) => {
      ...
      var key = id + "?" + 'city' + "?" + this.user.userId + "?" + '4063768d-34df-4829-a811-f92bebf857a1' + "?" + '08594f95-bdbb-4f0a-aa54-9ea5dc8c46c9';
      this.repository.GetSurveyCityJuly23(key).then((r) => {
  ...
  loadSubCityData(id) {
    ...
    if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {
      ...
      debugger;
      this.showloader = true;
      var key = id + "?" + 'subcity' + "?" + this.user.userId + "?" + '4063768d-34df-4829-a811-f92bebf857a1' + "?" + '08594f95-bdbb-4f0a-aa54-9ea5dc8c46c9';
      this.repository.GetSurveyCityJuly23(key).then((r) => {
        debugger;
  ...
  loadbuildingdata() {
    if (this.subCityId.length > 0) {
      ...
      this.repository.BuildingSectionDataEx(this.subCityId).then((r) => {
  ...
  loadTeachers(course) {
    ...
    if (this.cityId.length == 0 && this.subCityId.length == 0 ) {
      ...
      this.repository.TeacherRatingswithidJuly2023(key).then((r) => {
...
this.repository.July23TeacherRatingswithidSpecificCityWithBuilding(key.trim()).then((r) => {
  this.teacherRatingList = r as Array<ITeacherRatingOverAllListwithid>;
  ...
  this.teachCheck = true;
      ...
      this.repository.July2023TeacherRatingswithidSpecificCity(key.trim()).then((r) => {
        this.teacherRatingList = r as Array<ITeacherRatingOverAllListwithid>;
  ...
  loadSectionData(id) {
    ...
    this.repository.GetTeacherGraphSectionWisewithtotalJuly23Xx(key).then((r) => {
    ...
    this.repository.GetTeacherGraphSectionWisewithtotalJuly23EXx(key).then((r) => {
      this.SectionData = r as Array<ITeacherRatingGraphEXSectionwithtotal>;
      this.data1 = true;
  ...
  refreshData() {
    ...
    '4063768d-34df-4829-a811-f92bebf857a1' + "?" + '08594f95-bdbb-4f0a-aa54-9ea5dc8c46c9';
    this.repository.GetOverAllResultJuly23(key).then((r) => {
  ...
  loadData() {
    ...
    ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
          ...
          if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {
            ...
            this.repository.GetOverAllResult1July23WithBuilding(key.trim()).then((r) => {
              this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
              this.loadQuestions();
              this.loadsummery();
            });
            ...
            this.showloader = true;
            this.repository.GetOverAllResult1withposissionJuly2023(key).then((r) => {
              this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
          ...
          this.showloader = true;
          this.repository.GetOverAllResult1withposissionJuly23(key).then(r => {
            if (r) {
...
${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
    ...
    else
    {
      ...
      ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}`;
            this.showloader = true;
            this.repository.GetOverAllResult1July23(key.trim()).then((r) => {
              if (r) {
                this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
                this.loadQuestions();
                this.loadsummery();
