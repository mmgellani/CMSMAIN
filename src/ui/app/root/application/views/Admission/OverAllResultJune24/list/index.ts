...
export class OverAllResultJune24 extends Vue {
  ...
  loadTotalSurvey() {
    ...
    this.repository
      ...
      .TotalSurveyExJun24('e03292cf-244e-4435-b530-4ff0653bae4c?bb638a38-670c-4471-bf45-4ce602404cd8')
  ...
  loadCityDataSurvey(id) {
    ...
    if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {
      ...
      var key = id + "?" + 'city' + "?" + this.user.userId + "?" + 'e03292cf-244e-4435-b530-4ff0653bae4c' + "?" + 'bb638a38-670c-4471-bf45-4ce602404cd8';
      this.repository.GetSurveyCityJun24(key).then((r) => {
  ...
  loadSubCityData(id) {
    ...
    if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {
      ...
      debugger;
      this.showloader = true;
      var key = id + "?" + 'subcity' + "?" + this.user.userId + "?" + 'e03292cf-244e-4435-b530-4ff0653bae4c' + "?" + 'bb638a38-670c-4471-bf45-4ce602404cd8';
      this.repository.GetSurveyCityJun24(key).then((r) => {
        debugger;
...
this.repository.Jun24TeacherRatingswithidSpecificCityWithBuilding(key.trim()).then((r) => {
  ...
  refreshData() {
    ...
    'e03292cf-244e-4435-b530-4ff0653bae4c' + "?" + 'bb638a38-670c-4471-bf45-4ce602404cd8';
    this.repository.GetOverAllResultJun24(key).then((r) => {
  ...
  loadData() {
    ...
    ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
          ...
          this.showloader = true;
          this.repository.GetOverAllResult1withposissionJun24(key).then(r => {
            if (r) {
...
${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
    ...
    else
    {
      ...
      ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}`;
            this.showloader = true;
            this.repository.GetOverAllResult1Jun24(key.trim()).then((r) => {
              if (r) {
                this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
                this.loadQuestions();
                this.loadsummery();
