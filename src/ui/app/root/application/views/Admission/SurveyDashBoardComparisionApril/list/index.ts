...
export class SurveyDashBoardComparisionApril extends Vue {
  ...
  private surveyOverAllResultListpre: Array<ISurveyOverAllResultApril> = [];
  ...
  loadCampusData1(id) {
    ...
    this.repository.GetSurveyCityEXApril(key).then((r) => {
  ...
  loadTeacherspre(course) {
    ...
    if (this.cityId.length == 0 && this.subCityId.length == 0 && this.campusId.length == 0 && this.programId.length == 0 && this.classId.length == 0) {
      ...
      this.repository.April2022TeacherRatingswithidSpecificCity(key).then((r) => {
  ...
  refreshDatapre() {
    ...
    this.repository.GetOverAllResultApril(key).then((r) => {
      this.surveyOverAllResultListpre = r as Array<ISurveyOverAllResultApril>;
  ...
  loadDatapre() {
    ...
    if (this.whichModule.length > 0) {
      ...
      this.repository.GetOverAllResult1April(key).then((r) => {
        this.surveyOverAllResultListpre = r as Array<ISurveyOverAllResultApril>;
        this.loadQuestionspre();
      });
    } else {
