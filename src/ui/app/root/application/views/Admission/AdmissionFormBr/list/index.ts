...
export class AdmissionAdmissionFormListBr extends Vue {
  ...
  validatePage() {
    if (this.user.roles.indexOf("admin") >= 0) {
      ...
      if ("admissionAdmissionFormBr" in this.user.claims == true) {
        if (this.user.claims["admissionAdmissionFormBr"].indexOf("R") >= 0) {
          this.canRead = true;
        }
        if (this.user.claims["admissionAdmissionFormBr"].indexOf("C") >= 0) {
          this.canAdd = true;
        }
        if (this.user.claims["admissionAdmissionFormBr"].indexOf("U") >= 0) {
          this.canEdit = true;
        }
        if (this.user.claims["admissionAdmissionFormBr"].indexOf("D") >= 0) {
          this.canDelete = true;
        }
      } else {
  ...
  insertModel() {
    ...
    if (this.sessionId.length > 0 && this.campusId.length > 0) {
      ...
      this.$store.dispatch(StoreTypes.updateStatusBar, {
        text: "Please Select Session and Campus",
        title: "Success",
