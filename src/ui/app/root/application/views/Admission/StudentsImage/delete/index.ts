...
import { IAdmissionStudentsImage } from '../../../../models';
...
export class AdmissionStudentsImageDelete extends Vue {
    private repository: AdmissionStudentsImageService;
    private data: IAdmissionStudentsImage = { studentsImageId: '', studentId: '', image: '', statusId: 0, loggerId: '',  };
