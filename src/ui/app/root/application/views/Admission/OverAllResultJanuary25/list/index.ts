...
export class OverAllResultJanuary25 extends Vue {
  ...
  loadTotalSurvey() {
    ...
    // this.survey = [];
    // this.repository
    //   .TotalSurveyExJan24('b3228914-252e-4f90-b643-0047470059a6?5783ad6d-a901-4cfb-b160-1a8307752302')
    //   .then((response) => (this.survey = response as Array<ITotalSurveyJanuary2024>));
      this.survey = [];
      this.repository
        .TotalSurveyExJan25('3719e78c-fb4d-4945-b636-d2f19a014478?848a29aa-b211-4525-8419-b38a9c6c1259?d816070d-deae-42a8-8fac-77304039d2e1')
        .then((response) => (this.survey = response as Array<ITotalSurveyJanuary2024>));
  ...
  loadPosessionDataSurvey(id) {
    if (this.typeId == "Owned") {
      ...
      this.repository.SurveyStatisticsEx1LatestJanuary25(key).then((r) => {
        if (r) {
  ...
  loadCityDataSurvey(id) {
    ...
    if (this.buildingname.length > 0 && this.buildingname != '') {
      ...
      var key = this.subCityId + "?" + 'building' + "?" + this.user.userId + "?" +'3719e78c-fb4d-4945-b636-d2f19a014478' + "?" + '848a29aa-b211-4525-8419-b38a9c6c1259'+"?"+'d816070d-deae-42a8-8fac-77304039d2e1' + "?" + this.buildingname;
      this.repository.GetSurveyCityJanuary25WithBuilding(key).then((r) => {
      ...
      var key = id + "?" + 'city' + "?" + this.user.userId + "?" + '3719e78c-fb4d-4945-b636-d2f19a014478' + "?" + '848a29aa-b211-4525-8419-b38a9c6c1259'+"?"+'d816070d-deae-42a8-8fac-77304039d2e1';
      this.repository.GetSurveyCityJanuary25(key).then((r) => {
  ...
  loadSubCityData(id) {
    ...
    if (this.buildingname.length > 0 && this.buildingname != '') {
      ...
      this.showloader = true;
      var key = id + "?" + 'subcity' + "?" + this.user.userId + "?" + '3719e78c-fb4d-4945-b636-d2f19a014478' + "?" + '848a29aa-b211-4525-8419-b38a9c6c1259'+"?"+'d816070d-deae-42a8-8fac-77304039d2e1';
      this.repository.GetSurveyCityJanuary25(key).then((r) => {
  ...
  loadbuildingdata() {
    if (this.subCityId.length > 0) {
      ...
      this.repository.BuildingSectionData25(this.subCityId).then((r) => {
...
debugger;
    ...
    if (this.cityId.length == 0 && this.subCityId.length == 0 ) {
      ...
      this.repository.TeacherRatingswithidJanuary2025(key).then((r) => {
...
this.repository.Jan25TeacherRatingswithidSpecificCityWithBuilding(key.trim()).then((r) => {
  this.teacherRatingList = r as Array<ITeacherRatingOverAllListwithid>;
  ...
  this.teachCheck = true;
      ...
      this.repository.Januray25TeacherRatingswithidSpecificCity(key.trim()).then((r) => {
        this.teacherRatingList = r as Array<ITeacherRatingOverAllListwithid>;
  ...
  loadSectionData(id) {
    ...
    this.repository.GetTeacherGraphSectionWisewithtotalJanuary25Ex(key).then((r) => {
    ...
    this.repository.GetTeacherGraphSectionWisewithtotalJanuary25EXx(key).then((r) => {
      this.SectionData = r as Array<ITeacherRatingGraphEXSectionwithtotal>;
      this.data1 = true;
  ...
  refreshData() {
    ...
    var key = this.user.userId + "?" +
      '3719e78c-fb4d-4945-b636-d2f19a014478' + "?" + '848a29aa-b211-4525-8419-b38a9c6c1259' +"?"+ 'd816070d-deae-42a8-8fac-77304039d2e1';
    this.repository.GetOverAllResultJanuary25(key).then((r) => {
  ...
  loadData() {
    ...
    if (this.typeId == 'Owned') {
      ...
      if (this.whichModule.length > 0) {
        var key =
          `${this.Owned}?
      ${this.cityId != "" ? this.cityId : this.empty}?
      ${this.subCityId != "" ? this.subCityId : this.empty}?
      ${this.campusId != "" ? this.campusId : this.empty}?
      ${this.programId != "" ? this.programId : this.empty}?
      ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}`;


        if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {

          var key =
            `${this.Owned}?${this.cityId != "" ? this.cityId : this.empty}?
    ${this.subCityId != "" ? this.subCityId : this.empty}?
    ${this.campusId != "" ? this.campusId : this.empty}?
    ${this.programId != "" ? this.programId : this.empty}?
    ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
          ...
          if (this.buildingname.length > 0 && this.buildingname != '' && this.building[0].isBuilding == true) {
            ...
            this.repository.GetJanuary25SurveyOverAllWithBuildingCopy(key.trim()).then((r) => {
              this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
              this.loadQuestions();
              this.loadsummery();
            });
            ...
            this.showloader = true;
            this.repository.GetOverAllResult1withposissionJanuary25(key).then((r) => {
              this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
  ...
  ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
      ...
      var key = `${this.cityId != "" ? this.cityId : this.empty}?
${this.subCityId != "" ? this.subCityId : this.empty}?
${this.campusId != "" ? this.campusId : this.empty}?
${this.programId != "" ? this.programId : this.empty}?
${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}?${this.buildingname}`;
    ...
    else
    {
      ...
      ${this.classId != "" ? this.classId : this.empty}?${this.whichModule}?${this.user.userId}`;
            this.showloader = true;
            this.repository.GetSurveyOverAllJan2025(key.trim()).then((r) => {
              if (r) {
                this.surveyOverAllResultList = r as Array<ISurveyOverAllResultApril>;
                this.loadQuestions();
                this.loadsummery();
