...
export class FeeStudentChallanPaidDateList extends Vue {
  ...
  validatePage() {
    if (this.user.roles.indexOf("admin") >= 0) {
      ...
      if ("feeStudentChallanPaidList" in this.user.claims == true) {
        if (this.user.claims["feeStudentChallanPaidList"].indexOf("R") >= 0) {
          this.canRead = true;
        }
        if (this.user.claims["feeStudentChallanPaidList"].indexOf("C") >= 0) {
          this.canAdd = true;
        }
        if (this.user.claims["feeStudentChallanPaidList"].indexOf("U") >= 0) {
          this.canEdit = true;
        }
        if (this.user.claims["feeStudentChallanPaidList"].indexOf("D") >= 0) {
          this.canDelete = true;
        }
      } else {
