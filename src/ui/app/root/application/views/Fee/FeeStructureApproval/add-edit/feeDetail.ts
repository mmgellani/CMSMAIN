...
import { IFeeFeeHeadCheckBox, ISetupProgram, ISetupShift, ISetupClass, IFeeFeeHead } from '../../../../models';
...
export class FeeDetail extends Vue {
    ...
    private classList: Array<ISetupClass> = this.classList
