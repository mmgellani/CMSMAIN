...
import {TransportExemptionAddEdit } from './Exemption';
import {  TransportSubInstallmentAddEdit } from './SubInstallment';
import {  TransportChallanAddEdit } from './StudentChallan';
...
@Component({
    ...
    components: {
        ...
        'exemption': TransportExemptionAddEdit,
        'subInstallment': TransportSubInstallmentAddEdit,
        'challan': TransportChallanAddEdit,
...
export class HelperTransport extends Vue {
    ...
    cancel() {
        ...
        this.$modal.hide("helper-transport-modal");
    }
