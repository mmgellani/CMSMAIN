...
export class FeeExemptionManually extends Vue {
  ...
  validatePage() {
    if (this.user.roles.indexOf("admin") >= 0) {
      ...
      if ("feeExemptionManually" in this.user.claims == true) {
        if (this.user.claims["feeExemptionManually"].indexOf("R") >= 0) {
          this.canRead = true;
        }
        if (this.user.claims["feeExemptionManually"].indexOf("C") >= 0) {
          this.canAdd = true;
        }
        if (this.user.claims["feeExemptionManually"].indexOf("U") >= 0) {
          this.canEdit = true;
        }
        if (this.user.claims["feeExemptionManually"].indexOf("D") >= 0) {
          this.canDelete = true;
        }
      } else {
