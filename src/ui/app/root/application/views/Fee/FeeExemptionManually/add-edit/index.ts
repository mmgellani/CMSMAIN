...
import { FeeCampusBankLinkService, FeeCampusChallanNoteLinkService, FeeChallanTypeService, FeeStudentChallanService, SetupClassService } from "../../../../service";
import {
  ICampusBank,
...
getConcessionMarks() {
  ...
  filterData() {
    ...
    this.TempChallandata.forEach(e => {
      this.ManualExemptionList.push({
        ...
        , exemptedAmount: 0, fine: e.fine, collectorId: e.collectorId, challanTypeId: e.challanTypeId
      })
    })
  ...
  SaveManualExemption(admissionform: any, installno: any, amount: any, challanNo: any) {
  ...
  click(list) {
    this.SelectedExemptionList = [];
    this.SelectedExemptionList = list;
  }
