...
export class StudentFeeConfirmation extends Vue {
    ...
    validatePage() {
        if (this.user.roles.indexOf('admin') >= 0) {
            ...
            if (('feeConfirmation' in this.user.claims) == true) {
                if (this.user.claims['feeConfirmation'].indexOf('R') >= 0) {
                    this.canRead = true;
                }
                if (this.user.claims['feeConfirmation'].indexOf('C') >= 0) {
                    this.canAdd = true;
                }
                if (this.user.claims['feeConfirmation'].indexOf('U') >= 0) {
                    this.canEdit = true;
                }
                if (this.user.claims['feeConfirmation'].indexOf('D') >= 0) {
                    this.canDelete = true;
                }
            } else {
