...
export class CustomChallanAddEdit extends Vue {
            ...
            this.repoFeeHead.GetFindBy('s=>s.ChallanTypeId.ToString()=="' + this.challanTypeId + '"')
                .then(r => {
                    ...
                    if(this.challanTypeId=='9dbb0be3-2082-4839-9f4b-f6d35dbb7b63'){
                        ...
                        this.feeHeadList= this.feeHeadList.filter(x=>x.feeHeadId!='818adfaa-6a1e-4ac5-a905-ab650d3f11fc')
    ...
    loadFeeHeadName() {
        ...
        //this.feeHeadList= this.feeHeadList.filter(x=>x.feeHeadId!='818adfaa-6a1e-4ac5-a905-ab650d3f11fc')
        //e71843f9-c855-42a8-8e80-baad997fe25f
    ...
    save() {
        ...
        if (this.admissionFormId.length > 0 && this.feeHeadId.length > 0 && this.challanTypeId.length > 0 && this.classId.length > 0) {
            ...
            var key = this.admissionFormId + "?"  + this.amount + "?" + dated + "?" + this.feeHeadId + "?" + this.challanTypeId + "?" + this.remarks + "?" + this.classId
            console.log(key)
            this.isDisable = true;
            this.repoStudentchallan.GenerateCustomChallan(key)
                .then(r => {
                    this.isDisable = true;
