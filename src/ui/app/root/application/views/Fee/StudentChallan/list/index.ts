...
export class FeeStudentChallanList extends Vue {
  ...
  validatePage() {
    if (this.user.roles.indexOf("admin") >= 0) {
      ...
      if ("feeStudentChallan" in this.user.claims == true) {
        if (this.user.claims["feeStudentChallan"].indexOf("R") >= 0) {
          this.canRead = true;
        }
        if (this.user.claims["feeStudentChallan"].indexOf("C") >= 0) {
          this.canAdd = true;
        }
        if (this.user.claims["feeStudentChallan"].indexOf("U") >= 0) {
          this.canEdit = true;
        }
        if (this.user.claims["feeStudentChallan"].indexOf("D") >= 0) {
          this.canDelete = true;
        }
      } else {
