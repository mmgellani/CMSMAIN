...
export class StudentFeeConfirmationEx extends Vue {
        ...
        this.FeeChallanrepository.GetFindBy3(this.data.filterString).then(
            res => {
                ...
                if (this.StudentFeedata[0].installmentNo == 1) {
                    ...
                    this.FeeChallanrepository.InsertPaidDateAdmins(key).then(r => {
                        if (r.returnValue == 0) {
    ...
    validatePage() {
        if (this.user.roles.indexOf('admin') >= 0) {
            ...
            if (('feeConfirmationEx' in this.user.claims) == true) {
                if (this.user.claims['feeConfirmationEx'].indexOf('R') >= 0) {
                    this.canRead = true;
                }
                if (this.user.claims['feeConfirmationEx'].indexOf('C') >= 0) {
                    this.canAdd = true;
                }
                if (this.user.claims['feeConfirmationEx'].indexOf('U') >= 0) {
                    this.canEdit = true;
                }
                if (this.user.claims['feeConfirmationEx'].indexOf('D') >= 0) {
                    this.canDelete = true;
                }
            } else {
