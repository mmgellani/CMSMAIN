...
import { IRole, DefaultRole, ISecurityClaim } from "../../../../../../../../ui/app/model";
import { ICommonOptions, IVueSelectOption } from "../../../../../../../../ui/app/plugins";
import { PortletArea, PageArea } from "../../../../../../../../ui/app/components";
...
export class ReadRole extends Vue {
  ...
  description(id){
    ...
    return this.availableClaims.find(e=> e.securityClaimId == id).description;
