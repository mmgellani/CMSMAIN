...
import { IBoardStudentBoardLink, BoardFeePaidStudent, StudentBoardRegistration } from "../../../../models/Board/StudentBoardLink";
...
export interface StudentBoardRegistrationEx extends StudentBoardRegistration {
  isSelected: boolean;
  examtypeId:string;
  examyear:string
...
export class BoardCampusStudentRegistrationAddEdit extends Vue {
  ...
  private studentList: Array<StudentBoardRegistration> = [];
  private studentselectedListEx: Array<StudentBoardRegistrationEx> = [];
  ...
  loadEnrolledStudents() {
    ...
    this.studentselectedListEx=[];
      ...
      this.repository.GetStudentBoardUniversityExam(key)
        .then(r => {
          this.studentList = r as Array<StudentBoardRegistration>
  ...
  saveModel() {
   ...
   var z = this.studentselectedListEx.filter(e => e.isSelected == true);
    ...
    this.repository.InsertUniversityExamEntry((res)).then(r => {
