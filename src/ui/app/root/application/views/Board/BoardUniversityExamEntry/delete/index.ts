...
import { IBoardStudentBoardLink, StudentBoardRegistration, StudentBoardExamEntry } from "../../../../models/Board/StudentBoardLink";
...
export class BoardStudentBoardLinkEdit extends Vue {
  ...
  private data: StudentBoardExamEntry = {
  ...
  saveModel() {
    ...
    this.repository.UpdateExamEntry((this.data)).then(r => {
