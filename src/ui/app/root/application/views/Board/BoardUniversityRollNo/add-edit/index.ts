...
import { IBoardStudentBoardLink, BoardFeePaidStudent, StudentBoardRegistration, BoardUniversityRollData } from "../../../../models/Board/StudentBoardLink";
...
export class BoardCampusStudentRegistrationAddEdit extends Vue {
  ...
  private studentList: Array<BoardUniversityRollData> = [];
  private studentselectedListEx: Array<BoardUniversityRollDataEx> = [];
  ...
  loadEnrolledStudents() {
    ...
    this.studentList = [];
    this.studentselectedListEx=[];

   
    var key=this.sessionId+'?'+this.campusId+'?'+this.programId+'?'+this.classId+'?'+this.programDetailId+'?'+this.examtypeid+'?'+this.yer
          this.repository.GetBoardUniversityRollData(key)
        .then(r => {
          this.studentList = r as Array<BoardUniversityRollData>
          this.studentList.forEach(element => {
            this.studentselectedListEx.push({
  
              admissionFormId:element.admissionFormId,
              ...
              examTypeName:element.examTypeName
  ...
  checkAll() {
    if (this.selectAll == true) {
      this.studentselectedListEx.forEach(element => {
  ...
  saveModel() {
   ...
   var z = this.studentselectedListEx.filter(e => e.isSelected == true);


    var res = JSON.stringify(z);
   console.log(res);
    this.repository.InsertBoardUniversityRollNo((res)).then(r => {
