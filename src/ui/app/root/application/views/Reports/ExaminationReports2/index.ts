...
import { IExaminationExamSchedule, IExamScheduleExx } from "../../../models/Examination/ExamSchedule";
...
export class ExaminationReports2 extends Vue {
  ...
  generate() {
    ...
    if (this.check == "Subject Wise Award List") {
      ...
      // })
      console.log(this.sectionCourseLinkId);
      this.getExamSecWiseIndividReport(where)
  ...
  getEvaluateStudentsEx() {
    debugger;
    this.reportData = [];
    if (this.campusId.length > 0 && this.programId.length > 0 && this.programDetailId.length > 0 && this.classId.length > 0 && this.hodId.length > 0 && this.examTypeId.length > 0 && this.datestring.toString() != '' && this.courseId.length > 0 && this.sessionId.length > 0) {
      ...
      + '?' + this.programCourseLinkId+ '?' + this.sessionId);
