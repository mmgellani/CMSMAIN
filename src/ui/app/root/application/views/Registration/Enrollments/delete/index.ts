...
export class RegistrationEnrollmentsDelete extends Vue {
    private repository: RegistrationEnrollmentsService;
    private data: IRegistrationEnrollments = { enrollmentId: '', admissionFormId: '', sectionCourseLinkId: [], statusId: 0, loggerId: '',  };
