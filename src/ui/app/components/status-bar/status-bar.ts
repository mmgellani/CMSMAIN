...
@Component({
  ...
  template: `
    <transition name="fade">
      <div v-if="status.messageTypeId" @click.prevent="onStatusBarClick()" class="position" :class="alertClass" role="alert">
...
export class StatusBar extends Vue {
  ...
  clearAfter: number = (<any>this).clearAfter;
  localePrefix: string = (<any>this).localePrefix;
