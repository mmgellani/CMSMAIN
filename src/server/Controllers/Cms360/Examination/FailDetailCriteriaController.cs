...
namespace Cms360.UI.Controllers.Account
{
    ...
    public class ExaminationFailDetailCriteriaController : Controller
    {
        private readonly IExaminationFailDetailCriteriaRepository repository;
        ...
        public ExaminationFailDetailCriteriaController(IExaminationFailDetailCriteriaRepository repository,IUserLogService log, DbContextBase db)
        {
