...
namespace Cms360.UI.Controllers.Account
{
    ...
    public class SessionDurationController : Controller
    {
        private readonly ISessionDurationRepository repository;
        private readonly IUserLogService log;
        private readonly DbContextBase db;
        public SessionDurationController(ISessionDurationRepository repository, IUserLogService log, DbContextBase db)
        {
        ...
        {
            var options = ScriptOptions.Default.AddReferences(typeof(SessionDuration).Assembly);
            Expression<Func<SessionDuration, bool>> discountFilterExpression = FuncToExpression(await CSharpScript.EvaluateAsync<Func<SessionDuration, bool>>(predicate.ProvidedString, options));
        ...
        public IActionResult GetFindByVM([FromBody] Predicate predicate)
        {
            try
            {
                ...
                return Ok(this.db.VWSessionDuration.Where(s => s.CampusProgramId == campusProgramId && s.ClassId == classId && s.StatusId != 2));

            }
            catch (Exception ex)
            {
                AppException app = new AppException();
                app.Message = "ERROR IN SessionDurationController.GetFindByVM()" + ex.Message;
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult AddOne([FromBody] SessionDuration entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> AddOneAsync([FromBody] SessionDuration entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult AddMany([FromBody] IEnumerable<SessionDuration> entities)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> AddManyAsync([FromBody] IEnumerable<SessionDuration> entities)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult Update([FromBody] SessionDuration entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> UpdateAsync([FromBody] SessionDuration entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult Delete([FromBody] SessionDuration entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> DeleteAsync([FromBody] SessionDuration entity)
        {
