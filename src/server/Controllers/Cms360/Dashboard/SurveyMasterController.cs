...
namespace Cms360.UI.Controllers.Account
{
    ...
    {
        private readonly IDashboardSurveyMasterRepository repository;
        private readonly DbContextBase db;
        private readonly IUserLogService log;

        public SurveyMasterController(IDashboardSurveyMasterRepository repository, DbContextBase db, IUserLogService log)
        {
        ...
        [HttpGet]
        [Route("[action]")]
        public  IActionResult GetQueryType()
        {
            return Ok(this.db.QueryType.ToList());
        }
        ...
        {
            var options = ScriptOptions.Default.AddReferences(typeof(SurveyMaster).Assembly);
            Expression<Func<SurveyMaster, bool>> discountFilterExpression = FuncToExpression(await CSharpScript.EvaluateAsync<Func<SurveyMaster, bool>>(predicate.ProvidedString, options));
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult AddOne([FromBody] SurveyMaster entity)
        {
            try
            {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> AddOneAsync([FromBody] SurveyMaster entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult AddMany([FromBody] IEnumerable<SurveyMaster> entities)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> AddManyAsync([FromBody] IEnumerable<SurveyMaster> entities)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult Update([FromBody] SurveyMaster entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> UpdateAsync([FromBody] SurveyMaster entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public IActionResult Delete([FromBody] SurveyMaster entity)
        {
        ...
        [HttpPost]
        [Route("[action]")]
        public async Task<IActionResult> DeleteAsync([FromBody] SurveyMaster entity)
        {
